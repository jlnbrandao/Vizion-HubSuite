...
export const PermissionCode = {
  ...
  PRODUCTS_READ: 'platform.products.read',
...
export const PERMISSION_CATALOG: readonly PermissionCatalogEntry[] = [
  ...
  { code: 'platform.products.read', legacyCode: 'products.read', service: 'platform', resource: 'products', action: 'read', name: 'Read product instances', description: 'Allows listing registered distributable product instances' },
  { code: 'platform.products.manage', legacyCode: 'products.manage', service: 'platform', resource: 'products', action: 'manage', name: 'Manage product instances', description: 'Allows registering, probing and binding distributable products' },
